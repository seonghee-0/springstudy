...
public class CalculatorEx {
  ...
  public static void main(String[] args) {
    ...
    // @Component으로 만든 Bean 처리                 : AnnotationConfigApplicationContext 

    AbstractApplicationContext ctx = new AnnotationConfigApplicationContext(AppConfig.class); // AppConfig 등록
