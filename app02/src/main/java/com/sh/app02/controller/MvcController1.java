...
public class MvcController1 {
  ...
  /*
   *  1. 반환타입
   *   ★ 1) String       : 응답 JSP의 경로와 이름을 반환한다.
   *     2) void         : 요청 주소를 응답 JSP의 경로와 이름으로 인식한다.
   *     3) ModelAndView : 응답 JSP의 경로와 이름과 JSP로 보낼 데이터를 저장하는 객체이다.
   *  
   *  2. 메소드명
   *    의미 없다.
   *    
...
// welcome file
  ...
  public String welcome() {
     ...
     * return "index"; 해석하기
     * 
     * 1. servlet-context.xml (DispatcherServlet) 에 정의된 ViewResolver에 정보가 전달된다.
