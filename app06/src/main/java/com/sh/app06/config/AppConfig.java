 ...
 *                                                                (Advice)                                 */
  ...
  public SqlSessionFactory sqlSessionFactory() throws Exception {
    ...
    factoryBean.setConfigLocation(new PathMatchingResourcePatternResolver().getResource("classpath:com/sh/app06/mybatis/config/mybatis-config.xml"));
    factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/sh/app06/mybatis/mapper/*.xml"));
  ...
  public Advisor advisor() {
    ...
    pointcut.setExpression("execution(* com.sh.app06.service.*Impl.tx_*(..))");
